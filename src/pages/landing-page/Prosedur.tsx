            ...
            <div className="text-center lg:py-20 py-10 xl:px-52 lg:px-36 md:px-28 sm:px-16 px-8 xl:text-xl lg:text-lg sm:text-base text-sm relative">
                {isFetching ? (
                    ...
                    <Card radius="sm" shadow="sm">
                        <CardHeader className="text-center font-medium md:text-xl md:p-6 text-lg p-4 flex items-center justify-center">Prosedur di Perpustakaan</CardHeader>
                        <Divider />
                        <CardBody className="md:p-8 p-4 text-sm text-justify">
                            <div dangerouslySetInnerHTML={{ __html: FETCHING_DATA?.prosedur || "" }} />
                        </CardBody>
                    </Card>
                )}
            </div>
