    ...
    return (
        <div className="bg-[#e0e0e0]">
            <div className="relative md:h-[36rem] h-60">
                <img src={Background} alt="Background-landing-page" className="h-full w-full object-cover object-top" />
            ...
            <div className="text-center lg:py-20 py-10 xl:px-52 lg:px-36 md:px-28 sm:px-16 px-8 xl:text-xl lg:text-lg sm:text-base text-sm relative">
                {isFetching ? (
                    ...
                    <Card radius="sm" shadow="sm">
                        <CardHeader className="text-center font-medium md:text-xl md:p-6 text-lg p-4 flex items-center justify-center">Profil Perpustakaan</CardHeader>
                        <Divider />
                        <CardBody className="md:p-8 p-4 text-sm text-justify">
                            <div dangerouslySetInnerHTML={{ __html: FETCHING_DATA?.profil || "" }} />
                        </CardBody>
                    </Card>
                )}
            </div>
