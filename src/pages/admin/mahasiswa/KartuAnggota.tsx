...
export default function KartuAnggotaNahasiswa(){
    ...
    return (
        <main className="flex flex-col gap-4">
            ...
            <div className="bg-white lg:p-8 p-4 border shadow rounded-md flex flex-col gap-4">
                ...
                <Link to={`/data-anggota/mahasiswa/cetak-kartu/${id}`} className="mx-auto flex items-center justify-center gap-2 border border-primary p-2 text-white bg-primary px-4 rounded-lg" target="__blank">
                    <FaPrint /> Cetak Kartu
                </Link>
            </div>
        </main>
