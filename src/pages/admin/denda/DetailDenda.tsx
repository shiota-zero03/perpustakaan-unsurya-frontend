        ...
        <main className="flex flex-col gap-4">
            ...
            <div className="bg-white lg:p-8 p-4 border shadow rounded-md flex flex-col gap-4">
                <div className="border border-primary py-2 sm:px-4 px-2 sm:text-left text-center rounded-md">
                    <h1 className="text-primary font-semibold">DETAIL LAPORAN DENDA</h1>
                </div>
                <div>
                    <div className="flex flex-col gap-1 -mt-2">
                        <div className="grid sm:grid-cols-2 grid-cols-1 gap-2">
                            ...
                            <div>
                                ...
                                <Input
                                    value={dataToShow.status_pembayaran ? dataToShow.status_pembayaran : "-"}
                                    aria-label="Nomor Urut"
                            ...
                            <div>
                                ...
                                <Input
                                    type={"text"}
                                    value={dataToShow.tanggal_bayar ? formatDateDMYIn(dataToShow.tanggal_bayar) : "-"}
                                    aria-label="Nomor Urut"
                                    id="tanggal_bayar"
                                    variant="bordered"
                                    color="primary"
