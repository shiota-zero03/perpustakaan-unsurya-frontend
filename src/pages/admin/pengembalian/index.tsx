...
export default function DataBerita(){
                ...
                cell: ({ row }: { row: Row<TransactionRes> }) => {
                    ...
                    return (
                        <div className="flex items-center gap-2">
                            <Button onPress={() => navigate(`/data-transaksi/pengembalian/detail/${transaction_code}`)} isIconOnly size="sm" variant="bordered" color="primary"><BsEye /></Button>
                            {!tanggal_pengembalian && (
                                <Button onPress={() => navigate(`/data-transaksi/pengembalian/edit-data/${transaction_code}`)} isIconOnly size="sm" variant="bordered" color="warning"><BiEdit /></Button>
                            )}
    ...
    return (
        <main className="flex flex-col gap-4">
            ...
            <div className="bg-white p-4 border shadow rounded-md flex flex-col gap-4 hidden">
                <div className="flex items-center justify-between sm:flex-row flex-col gap-2">
                    <Button
                        ...
                        onPress={() => navigate('/data-transaksi/pengembalian/tambah-data')}
                    >
                        <BsPlusSquareFill /> Tambah Data Pengembalian
                    </Button>
                    <Button
